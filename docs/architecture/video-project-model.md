...
3. Reusable overlays belong in `src/overlay_kit/`; one-off scene wiring stays in project folders.
4. Each major visual beat should be wrapped in a named `<Sequence>` for Studio timeline legibility.
5. Active execution state belongs in `docs/projects/<project>/tasks.md`.
