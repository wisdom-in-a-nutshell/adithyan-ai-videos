...
export const TEXT_EFFECTS_SETUP_ARTIFACTS_SECONDS = 33.84;
export const TEXT_EFFECTS_SETUP_CODING_START_SECONDS = 35.08;
export const TEXT_EFFECTS_SETUP_VIDEO_START_SECONDS = 43.44;
